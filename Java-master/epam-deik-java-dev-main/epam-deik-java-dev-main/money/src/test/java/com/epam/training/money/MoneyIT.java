...
public class MoneyIT {
    ...
    public void testAddReturnsNullWhenCurrencyWithUnknownRateIsUsed() {
        ...
        // When - Then
        assertThrows(UnsuppertedOperationException.class, () -> underTest.add(moneyToAdd);
    }
    ...
    public void testCompareToReturnsNullWhenCurrencyWithUnknownRateIsUsed() {
        ...
        // When - Then
        assertThrows(UnsuppertedOperationException.class, () -> underTest.compareTo(moneyToCompareWith));
    }
