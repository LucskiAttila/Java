...
public class AttachPriceComponentScreeningCommandHandler {
    ...
    public AttachPriceComponentScreeningCommandHandler(AttachPriceComponentScreeningCommand attachPriceComponentScreeningCommand) {
    ...
    public String AttachPriceComponentScreening(String name, String title, String roomName, String startsDateTime) {
        ...
        switch (result) {
            ...
            case "movie room component ":
                return StringUtils.capitalize(title) + "movie, " + roomName + "room, " + name + "price component doesn't exists";
            case "exist":
                return StringUtils.capitalize(title) + ", " + roomName + ", " + name + "screening doesn't exists";
            case "format":
