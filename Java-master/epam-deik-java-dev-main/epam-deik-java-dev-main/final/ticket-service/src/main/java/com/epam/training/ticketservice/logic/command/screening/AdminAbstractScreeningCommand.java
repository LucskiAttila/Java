...
public abstract class AdminAbstractScreeningCommand extends AdminAbstract {
    ...
    protected boolean setProperties() {
        ...
        if (!components.contains(priceComponent)) {
            ...
            startsDateAndTime_date = screening.getStartsDateTime();
    ...
    protected boolean isValid() {
        return screeningRepository.findByMovieAndRoomAndStartsDateTime(movie, room, startsDateAndTime_date) != null;
    }
    ...
    protected void save() {
        screeningRepository.save(new Screening(movie, room, startsDateAndTime_date, components));
    }
